...
echo "<p>Trying to delete record with id=$id</p>" ;

$client = new XML_RPC_Client('/xmlrpc/object', "http://$HOST:$PORT");
$client->setDebug($DEBUG);

$ids = array ( // Ids of the records to delete
...
$msg->addParam(new XML_RPC_Value('unlink', 'string'));    // The ORM method
$msg->addParam(new XML_RPC_Value($ids, 'array'));         // List of id of the records to delete
